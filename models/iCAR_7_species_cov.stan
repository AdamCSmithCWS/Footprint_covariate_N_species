...
//species 1
  ...
  int<lower=0> route_cov1[ncounts1];              // route observations - nested in species
...
//species 2
  ...
  int<lower=0> route_cov2[ncounts2];              // route observations - nested in species
...
//species 3
  ...
  int<lower=0> route_cov3[ncounts3];              // route observations - nested in species
...
//species 4
  ...
  int<lower=0> route_cov4[ncounts4];              // route observations - nested in species
...
//species 5
  ...
  int<lower=0> route_cov5[ncounts5];              // route observations - nested in species
...
//species 6
  ...
  int<lower=0> route_cov6[ncounts6];              // route observations - nested in species
...
//species 7
  ...
  int<lower=0> route_cov7[ncounts7];              // route observations - nested in species
...
vector[ncounts7] noise_raw7;
  ...
  //real age[nages]; //age-effect smooth
